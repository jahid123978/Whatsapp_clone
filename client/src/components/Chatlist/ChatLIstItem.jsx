...
function ChatLIstItem({ data, isContactPage = false }) {
 ...
 const handleContactClick = ()=>{
  ...
  return (
    <div
    className={`flex cursor-pointer items-center hover:bg-background-default-hover rounded-md`}
    onClick={handleContactClick}
    >
      <div className="min-2-fit px-5 pt-3 pb-1">
      ...
      <div className="min-h-full flex flex-col justify-center mt-3 pr-2 w-full">
        ...
        <div className="flex border-conversation-border pb-2 pt-1 pr-2">
          <div className="flex justify-between w-full">
            <span className="text-secondary line-clamp-1 text-sm">
              {isContactPage? data?.about || "\u00A0" : 
              <div className="flex items-center gap-1 mx-w-[200px]
              sm:mx-w-[250px] md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px] 
              ">
                {
