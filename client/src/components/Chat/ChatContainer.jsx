  ...
  return (<div className="h-[80vh] w-full relative flex-grow overflow-auto custom-scrollbar">
     ...
     <div className="flex flex-col justify-end w-full gap-1 overflow-auto">
      ...
      >
       ...
       { message.type === "text" && 
          <div className={`text-white px-2 py-[5px] tex-sm rounded-md flex gap-2 items-end max-w-[45%] ${message.senderId === currentChatUser.id? "bg-incoming-background": "bg-outgoing-background" }`}>
