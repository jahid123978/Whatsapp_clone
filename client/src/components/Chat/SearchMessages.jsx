...
function SearchMessages() {
  ...
  return <div className="border-concersation-border border-1 w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen text-primary-strong">
    ...
    <div className="overflow-auto custom-scrollbar h-full">
      ...
      <div className="flex justify-center h-full flex-col">
         {
          searchTerm.length>0 && !searchMessages.length && <span className="text-secondary w-full justify-center">
            No messages found
          </span>
         } 
         <div className="flex flex-col w-full h-full">
          {
           searchMessages.map((message)=><div className="flex cursor-pointer flex-col justify-center hovar:bg-background-default-hovar w-full px-5 border-b-[0.1px] border-secondary py-5">
